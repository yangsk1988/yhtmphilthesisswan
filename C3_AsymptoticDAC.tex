...
\subsubsection{Find Convergent Weight Matrix for First Order DAC}
...
The FO-DAC algorithm that uses best constant weight matrix \prettyref{eq:Best Const. Mtx}
is called the best constant first-order DAC algorithm (BC FO-DAC). 

Substitute this best constant weight matrix into \prettyref{eq: Opt. FO-DAC Problem},
...
As shown in Eq.\eqref{eq: High order spectral radius problem}, the
...
\begin{figure}
\hfill{}\includegraphics[width=10cm]{D:/Dropbox/PaperWork/FirstYearReport/Lyx_v/images/3order_max_lambda}\hfill{}\hfill{}\caption{\label{fig:Find-minimum-rho(H)} Find the minimum on the surface,
...
\begin{figure}
\hfill{}\includegraphics[width=10cm]{\string"Graph/Convergence region\string".pdf}\hfill{}\hfill{}\caption{\label{fig:Convergence-Region}Convergence Region for second order
DAC. $R_{1}$ and $R_{2}$ are defined in \prettyref{eq:Def Convergence region R1 R2}.
...
\begin{figure}[h]
\hfill{}\subfloat[\label{fig:Net-N50-E200}]{\includegraphics[bb=250bp 0bp 750bp 513bp,clip,width=7cm,height=7cm]{\lyxdot \lyxdot /FirstYearReport/Lyx_v/images/Net50Edges200}

}\hfill{}\subfloat[\label{fig:Net-N16-R0,3}]{\includegraphics[width=7cm]{\lyxdot \lyxdot /FirstYearReport/Lyx_v/images/Network_N16_R0,3}
...
\begin{figure}
\hfill{}\subfloat[\label{fig:DAC-SR-comp} ]{\includegraphics[width=10cm]{\string"../FirstYearReport/Lyx_v/images/Spectrum radius Compare_old_Ord1234\string".pdf}}\hfill{}\subfloat[\label{fig:DAC MSE Compare} ]{\includegraphics[width=10cm]{\lyxdot \lyxdot /FirstYearReport/Lyx_v/images/DAC_Compr_ord1234&hybrid}
